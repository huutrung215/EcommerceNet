...
namespace _19T1021289.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult Index(OrderSearchInput input)
        {
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            var detail = OrderService.ListOrderDetails(id);
        ...
        public ActionResult UpdateDetail(OrderDetail data)
        {
            ...
            if (string.IsNullOrWhiteSpace(data.SalePrice.ToString()))
                ModelState.AddModelError("SalePrice", "Gía bán không được để trống");
        ...
        public ActionResult DeleteDetail(int orderID = 0, int productID = 0)
        {
            ...
            OrderService.DeleteOrderDetail(orderdetail.OrderID, orderdetail.ProductID);
        ...
        public ActionResult UpdateShipping(Order order)
        {
            if (string.IsNullOrWhiteSpace(order.ShipperID.ToString()))
                ModelState.AddModelError("ShipperID", "Người giao hàng không được để trống");

            int shipper = (int)order.ShipperID;
            if (order.ShipperID != 0)
                OrderService.ShipOrder(order.OrderID, shipper);
        ...
        public ActionResult Reject(int id = 0)
        {
            ...
            OrderService.RejectOrder(order.OrderID);
