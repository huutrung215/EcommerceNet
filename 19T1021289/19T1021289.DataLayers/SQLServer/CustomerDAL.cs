    ...
    public class CustomerDAL : _BaseDAL, ICommonDAL<Customer>
    {
        ...
        public int Add(Customer data)
        {
            ...
            using (SqlConnection cn = OpenConnection())
            {
                ...
                /*ExecuteScalar, được sử dụng để thực thi một câu lệnh truy vấn và trả về giá trị đơn, 
                    thường là giá trị đầu tiên của hàng đầu tiên trong tập kết quả trả về.*/
